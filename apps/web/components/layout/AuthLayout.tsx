...
import { ClientOnly, Wordmark } from "../common";
...
type AuthLayoutProps = React.FC<
  PropsWithChildren<{ variant: "login" | "register" }>
>;

export const AuthLayout: AuthLayoutProps = ({ variant, children }) => {
  return (
